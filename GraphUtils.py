...
class GraphUtils:
    ...
    def replace_id(self, attribute_name, graph=True):
        ...
        for e in self.xml_doc.findall(".//gml:key[@attr.name='" + attribute_name + "'][@for='" + element + "']",
                                      self.namespaces):
            id = e.attrib.get('id')
        ...
        if file_path:
            ...
            if path.is_file():
                ...
                try:
                    ...
                    attributes = ['designName', 'serie', 'target_market', 'drive_wheels', 'battery_type', 'price',
                                  'horsepower', 'mpg', 'cylinder',
